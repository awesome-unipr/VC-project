    ...
    def on_message(self, client, userdata, msg):
        ...
        match msg.topic:
            ...
            case "vc2324/weather-current":
                ...
                if data["weather"] == "Rainy" or data["weather"] == "Snowy" or data["weather"] == "Misty" or data["weather"] == "Stormy":
            ...
            case "vc2324/dms":
                ...
                elif data == "Drunk" or data == "Sleepy" or data == "Dizzy" or data == "Unpresent":
